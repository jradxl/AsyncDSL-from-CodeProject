...
namespace DmitriNesteruk.AsyncDsl
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.AsyncDslEditorFactoryId)]
	internal partial class AsyncDslEditorFactory : AsyncDslEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new AsyncDslEditorFactory.
		/// </summary>
		public AsyncDslEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class AsyncDslEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected AsyncDslEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new AsyncDslDocData(this.ServiceProvider, typeof(AsyncDslEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new AsyncDslDocView(docData, this.ServiceProvider);
		}
	}
}
