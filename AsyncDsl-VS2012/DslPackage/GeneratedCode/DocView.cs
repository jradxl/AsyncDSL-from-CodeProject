...
namespace DmitriNesteruk.AsyncDsl
{
	...
	/// </summary>
	internal partial class AsyncDslDocView : AsyncDslDocViewBase
	{
		/// <summary>
		/// Constructs a new AsyncDslDocView.
		/// </summary>
		public AsyncDslDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class AsyncDslDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new AsyncDslDocView.
		/// </summary>
		protected AsyncDslDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			AsyncDslDocDataBase docData = this.DocData as AsyncDslDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for AsyncDslDocViewBase should be an AsyncDslDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::DmitriNesteruk.AsyncDsl.AsyncDslDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::DmitriNesteruk.AsyncDsl.AsyncDslDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::DmitriNesteruk.AsyncDsl.AsyncDslToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::DmitriNesteruk.AsyncDsl.AsyncDslToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.AsyncDslDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::DmitriNesteruk.AsyncDsl.AsyncDslHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::DmitriNesteruk.AsyncDsl.AsyncDslHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::DmitriNesteruk.AsyncDsl.AsyncDslHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
