...
{
	/// <summary>
	/// Partial class to handle serialization of ExampleModel instance as a root-level XML element.
	/// </summary>
	public partial class ExampleModelSerializer
	{
		/// <summary>
		/// Public ReadRootElement() method that deserializes a root-level ExampleModel instance from XML.
		/// </summary>
				...
				if (schemaResolver != null)
				{
					...
					if (!string.IsNullOrEmpty(targetNamespace))
					{
						...
						if (schemas != null && schemas.Count > 0)
						{
							if (schemas.Count > 1)
							{
								AsyncDslSerializationBehaviorSerializationMessages.AmbiguousSchema(serializationContext, reader, targetNamespace, schemas[0]);
							}
							...
							AsyncDslSerializationBehaviorSchemaValidationCallback validationCallback = new AsyncDslSerializationBehaviorSchemaValidationCallback(serializationContext);
						...
						{
							AsyncDslSerializationBehaviorSerializationMessages.NoSchema(serializationContext, reader, targetNamespace);
						}
					}
				}
		...
		/// </summary>
		private sealed class AsyncDslSerializationBehaviorSchemaValidationCallback
		{
			...
			internal AsyncDslSerializationBehaviorSchemaValidationCallback(DslModeling::SerializationContext serializationContext)
			{
				global::System.Diagnostics.Debug.Assert(serializationContext != null);
			...
			internal void Handler(object sender, global::System.Xml.Schema.ValidationEventArgs e)
			{
				...
				if (this.serializationContext != null)
					AsyncDslSerializationBehaviorSerializationMessages.SchemaValidationError(this.serializationContext, this.reader, e.Message);
			}
			#endregion
		}
	
		/// <summary>
		/// Public WriteRootElement() method that serializes a root-level ExampleModel instance to XML.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
		/// <param name="element">ExampleModel instance that will be serialized.</param>
		...
		public override void WriteRootElement(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer)
		{
			...
			rootElementSettings.SchemaTargetNamespace = "http://schemas.microsoft.com/dsltools/AsyncDsl";
...
{
	/// <summary>
	/// Partial class to handle serialization of AsyncDslDiagram instance as a root-level XML element.
	/// </summary>
	public partial class AsyncDslDiagramSerializer
	{
		/// <summary>
		/// Public ReadRootElement() method that deserializes a root-level AsyncDslDiagram instance from XML.
		/// </summary>
		/// <param name="serializationContext">Serialization context.</param>
...
{
	/// <summary>
	/// Helper class for serializing and deserializing AsyncDsl models.
	/// </summary>
	public abstract partial class AsyncDslSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Constructor
		/// </summary>
		protected AsyncDslSerializationHelperBase() { }
		#endregion
		...
		/// </param>
		/// <returns>The loaded ExampleModel instance.</returns>
		public virtual ExampleModel LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Store store, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController)
		{
			#region Check Parameters
			if (store == null) 
				throw new global::System.ArgumentNullException("store");
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		/// <returns>In-memory stream containing the serialized AsyncDslDiagram instance.</returns>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		...
		/// </param>
		/// <returns>The loaded ExampleModel instance.</returns>
		public virtual ExampleModel LoadModelAndDiagram(DslModeling::Store store, string modelFileName, string diagramFileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController)
		{
		...
		/// </param>
		/// <returns>The loaded ExampleModel instance.</returns>
		public virtual ExampleModel LoadModelAndDiagram(DslModeling::SerializationResult serializationResult, DslModeling::Store store, string modelFileName, string diagramFileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController)
		{
			#region Check Parameters
			if (store == null)
				throw new global::System.ArgumentNullException("store");
		...
		/// <param name="diagram">AsyncDslDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, ExampleModel modelRoot, string modelFileName, AsyncDslDiagram diagram, string diagramFileName)
		{
		...
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, ExampleModel modelRoot, string modelFileName, AsyncDslDiagram diagram, string diagramFileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, ExampleModel modelRoot, string modelFileName, AsyncDslDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		/// <param name="diagram">AsyncDslDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, AsyncDslDiagram diagram, string diagramFileName)
		{
		...
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, AsyncDslDiagram diagram, string diagramFileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <summary>
		/// Saves the given AsyncDslDiagram to the given file, with specified encoding.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the save operation.</param>
		/// <param name="diagram">AsyncDslDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, AsyncDslDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		public virtual string GetSerializedModelString(global::DmitriNesteruk.AsyncDsl.ExampleModel modelRoot, global::System.Text.Encoding encoding)
		{
		...
		/// <summary>
		/// DomainXmlSerializerDirectory instance used by this AsyncDslSerializationHelper class.
		/// </summary>
		...
		protected virtual DslModeling::DomainXmlSerializerDirectory Directory
		{
			...
			get
			{
				if (this.directory == null)
				{
					...
					directory.AddBehavior(AsyncDslSerializationBehavior.Instance);
				}
	...
	/// Helper class for serializing and deserializing AsyncDsl models.
	/// </summary>
	public sealed partial class AsyncDslSerializationHelper : AsyncDslSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Private constructor to prevent direct instantiation.
		/// </summary>
		private AsyncDslSerializationHelper() : base () { }
		#endregion
		...
		/// Singleton instance.
		/// </summary>
		private static AsyncDslSerializationHelper instance;
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)] // Will trigger creation otherwise.
		public static AsyncDslSerializationHelper Instance
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get
			{
				if (AsyncDslSerializationHelper.instance == null)
					AsyncDslSerializationHelper.instance = new AsyncDslSerializationHelper();
				return AsyncDslSerializationHelper.instance;
			}
		}
		#endregion
	}
