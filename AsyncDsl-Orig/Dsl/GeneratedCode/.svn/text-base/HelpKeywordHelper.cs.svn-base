...
namespace DmitriNesteruk.AsyncDsl
{
	...
	/// </remarks>
	public partial class AsyncDslHelpKeywordHelper : AsyncDslHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new AsyncDslHelpKeywordHelper.
		/// </summary>
		protected AsyncDslHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the AsyncDslHelpKeywordHelper.
		/// </summary>
		public static AsyncDslHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class AsyncDslHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new AsyncDslHelpKeywordHelperBase.
		/// </summary>
		protected AsyncDslHelpKeywordHelperBase()
			: base() { }
