...
namespace DmitriNesteruk.AsyncDsl
{
	...
	internal abstract class AsyncDslDocViewBase : DslShell::SingleDiagramDocView
	{
		...
		protected override bool LoadView()
		{
			...
			global::System.Collections.ObjectModel.ReadOnlyCollection<global::DmitriNesteruk.AsyncDsl.AsyncDslDiagram> diagrams = this.DocData.Store.ElementDirectory.FindElements<global::DmitriNesteruk.AsyncDsl.AsyncDslDiagram>();
			if (diagrams.Count > 0)
			{
