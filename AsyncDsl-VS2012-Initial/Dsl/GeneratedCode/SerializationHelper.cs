...
namespace DmitriNesteruk.AsyncDsl
{
	...
	partial class AsyncDslDomainModel
	{
		///<Summary>
		...
		partial void InitializeSerialization(DslModeling::Store store)
		{
			...
			AsyncDslSerializationHelper.Instance.InitializeSerialization(store);	
		}
	}
	...
	public abstract partial class AsyncDslSerializationHelperBase
	{
		...
		internal protected virtual void InitializeSerialization(DslModeling::Store store)
		{
			...
			DslModeling::IMonikerResolver monikerResolver = store.FindMonikerResolver(AsyncDslDomainModel.DomainModelId);
			if (monikerResolver == null)
			{
				monikerResolver = new AsyncDslSerializationBehaviorMonikerResolver(store, directory);
				store.AddMonikerResolver(AsyncDslDomainModel.DomainModelId, monikerResolver);
			}
...
namespace DmitriNesteruk.AsyncDsl
{
	...
	partial class AsyncDslSerializationHelperBase
	{
				...
				using (global::System.IO.FileStream fileStream = global::System.IO.File.OpenRead(fileName))
				{
					...
					using (DslModeling::Transaction t = partition.Store.TransactionManager.BeginTransaction("Load Model from " + fileName, true, transactionContext))
					{
						...
						if (fileStream.Length > 5)
						{
							try
							{
								global::System.Xml.XmlReaderSettings settings = AsyncDslSerializationHelper.Instance.CreateXmlReaderSettings(serializationContext, false);
		...
		internal global::System.IO.MemoryStream InternalSaveModel(DslModeling::SerializationResult serializationResult, ExampleModel modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			...
			global::System.Xml.XmlWriterSettings settings = AsyncDslSerializationHelper.Instance.CreateXmlWriterSettings(serializationContext, false, encoding);
		...
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		internal global::System.IO.MemoryStream InternalSaveDiagram(DslModeling::SerializationResult serializationResult, AsyncDslDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert(serializationResult != null);
			...
			// MonikerResolver shouldn't be required in Save operation, so not calling SetupMonikerResolver() here.
			serializationContext.WriteOptionalPropertiesWithDefaultValue = writeOptionalPropertiesWithDefaultValue;
			global::System.Xml.XmlWriterSettings settings = AsyncDslSerializationHelper.Instance.CreateXmlWriterSettings(serializationContext, true, encoding);
			using (global::System.Xml.XmlWriter writer = global::System.Xml.XmlWriter.Create(newFileContent, settings))
			{
		...
		public virtual ExampleModel LoadModelAndDiagram(DslModeling::SerializationResult serializationResult, DslModeling::Partition modelPartition, string modelFileName, DslModeling::Partition diagramPartition, string diagramFileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			...
			DslModeling::DomainClassXmlSerializer diagramSerializer = directory.GetSerializer(AsyncDslDiagram.DomainClassId);
		...
		internal protected virtual AsyncDslDiagram CreateDiagramHelper(DslModeling::Partition diagramPartition, DslModeling::ModelElement modelRoot)
		{
			...
			if (DslModeling::DomainRoleInfo.GetAllElementLinks(modelRoot).Count == 0)
			{
				...
				mappedElement = CreateSwimLaneRootForThreadSwimLane(modelPartition);
		...
		/// <summary>
		/// Create the root element for the ThreadSwimLane swimlane.
		/// </summary>
		/// <param name="modelPartition">Partition in which the swimlane's root element should be instantiated.</param>
		protected virtual Process CreateSwimLaneRootForThreadSwimLane(DslModeling::Partition modelPartition)
		{
			return new Process(modelPartition);
		}
