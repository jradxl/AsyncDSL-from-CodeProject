...
namespace DmitriNesteruk.AsyncDsl
{
	...
	/// </summary>
	internal abstract partial class AsyncDslDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::DmitriNesteruk.AsyncDsl.AsyncDslDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::DmitriNesteruk.AsyncDsl.AsyncDslDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::DmitriNesteruk.AsyncDsl.AsyncDslDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			modelRoot = global::DmitriNesteruk.AsyncDsl.AsyncDslSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
